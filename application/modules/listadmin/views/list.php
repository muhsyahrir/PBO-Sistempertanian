        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <button class="btn btn-outline-primary mb-5 mr-2" data-toggle="modal" data-target="#tambahbarang"><i
                            class="fas fa-plus mr-2"></i>Tambah Barang</button>
                    <a class="btn btn-outline-primary mb-5  " href="inputadmin/dashboard"><i
                            class="fas fa-cubes mr-2"></i>Detail</a>
                    ...
                    <table class="table table-bordered table-hover text-center">
                        ...
                        <tr>
                            ...
                            <td><?php echo anchor('listadmin/listadmin/edit/' .$brg->id, '<div class="btn btn-success btn-sm"><i class="fas fas fa-edit"></i></div>') ?>
                            </td>
                            <td><?php echo anchor('listadmin/listadmin/hapus/' .$brg->id, '<div class="btn btn-danger btn-sm"><i class="fas fas fa-trash"></i></div>') ?>
                            </td>
                </div>
                </tr>
                <?php endforeach; ?>
